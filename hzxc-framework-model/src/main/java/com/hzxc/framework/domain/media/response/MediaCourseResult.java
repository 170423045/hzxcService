package com.hzxc.framework.domain.media.response;

import com.hzxc.framework.domain.media.MediaFile;
import com.hzxc.framework.domain.media.MediaVideoCourse;
