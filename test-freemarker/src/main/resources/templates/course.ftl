...
<div class="article-banner">
    ...
    <div class="banner-info">
        <div class="banner-left">
            ...
            <p class="info">
                <a href="http://ucenter.hzxc.com/#/learning/${courseBase.id}/0"  target="_blank" v-if="learnstatus == 1" v-cloak>马上学习</a>
	    ...
	    <#if (coursePic.pic)??>
	     <p><img src="http://123.56.158.1/${coursePic.pic}" alt="" width="270" height="156"> </p>
	     <#else>
            ...
            <div class="article-cont-ask">
                ...
                <div class="article-right-box">
                    <div class="about-teach">
                        ...
                        <p class="synopsis">汇知是一家专门致力于高素质软件开发人才培养的高科技公司。汇知致力于为企业优选一流的人才的培训理念，以“学员自学入门教程，通过基础考核后进行强化培训”为招生原则，以“针对企业需求，重视基础理论建设，强化高端应用技能”为教学目标，以“高薪保证强大的资深教育团队”为教学后盾，彻底解决所有培训学员的后顾之忧，并解决用人企业难以招聘到合格人才的困扰。</p>
                    </div>
                    <div class="learing-box">
                        <div class="tit">看过该课的同学也在看</div>
                        <div class="item-box">
